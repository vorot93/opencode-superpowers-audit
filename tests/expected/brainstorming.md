...
**Terminal states are path-bound.** Architectural: run superpowers-audit after spec self-review, then invoke
writing-plans after the human approves the written spec — never frontend-design,
